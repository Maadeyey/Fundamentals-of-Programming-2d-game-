...
class Canvas extends JPanel {
    ...
    private BufferedImage monster_2;
    ...
    private void loadTileImages() {
        try {
            ...
            monster_2 = ImageIO.read(new File("assets/monster_2.png"));
            assert monster_2.getHeight() == GameGUI.TILE_HEIGHT &&
                    monster_2.getWidth() == GameGUI.TILE_WIDTH;
            ...
            fire = ImageIO.read(new File("assets/fire.png"));
            assert fire.getHeight() == GameGUI.TILE_HEIGHT &&
                    fire.getWidth() == GameGUI.TILE_WIDTH;
        } catch (IOException e) {
    ...
    private void drawDungeon(Graphics g) {
                    ...
                    if (currentTiles[i][j] != null) {   //checks a tile exists
                        switch (currentTiles[i][j]) {
                            ...
                            case STAIRS:
                                ...
                                break;
                            case FIRE:
                                g2.drawImage(fire, i * GameGUI.TILE_WIDTH, j * GameGUI.TILE_HEIGHT, null);
                        }
                    }
                }
            }
        ...
        if (currentMonsters != null)
            for(Entity mon : currentMonsters)
                if (mon != null) {
                    if (mon.getType() == EntityType.SPECIAL_MONSTER) {
                        g2.drawImage(monster_2, mon.getX() * GameGUI.TILE_WIDTH, mon.getY() * GameGUI.TILE_HEIGHT, null);
